...
- **Date / Time**: 2026-09-09 16:05:52 UTC
- **Hostname**: pc-th
- **Kernel**: 6.18.49
- **Log Directory**: `/home/withoutboat/nix-core/tests/2026-09-09_16-05-09`
...
| **VPN Endpoint (144.31.154.165)** | ✅ Reachable via wlo1 | Physical path reachability to server |
...
table inet awg_bypass {
	set bypass_v4 {
		type ipv4_addr
		timeout 1h
		elements = { 75.2.60.5 expires 59m17s958ms,
			     99.83.231.61 expires 59m17s955ms,
			     140.82.121.3 expires 59m55s521ms,
			     140.82.121.4 expires 59m17s623ms }
	}
}
```
...
peer: 2c1o9//w190B6DvPgsrJUr2+3wonW3NzNUojYxjMkkg=
  ...
  transfer: 0 B received, 7.08 KiB sent
