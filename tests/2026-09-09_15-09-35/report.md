...
- **Date / Time**: 2026-09-09 15:10:58 UTC
- **Hostname**: pc-th
- **Kernel**: 6.18.49
- **Log Directory**: `/home/withoutboat/nix-core/tests/2026-09-09_15-09-35`
...
| **Upstream DNS (1.1.1.1)** | ❌ Unreachable | Direct bypass ICMP reachability |
| **Local dnsmasq (127.0.0.1)** | ❌ Failing | Port 53 resolution via dnsmasq |
| **Domain Bypass (github.com)** | ❌ Failed | HTTPS connectivity to bypass domain |
...
table inet awg_bypass {
	set bypass_v4 {
		type ipv4_addr
		timeout 1h
		elements = { 75.2.60.5 expires 32m13s87ms,
			     99.83.231.61 expires 32m13s90ms,
			     140.82.112.22 expires 49m40s375ms,
			     140.82.113.21 expires 29m20s86ms,
			     140.82.113.22 expires 31m54s866ms,
			     140.82.114.21 expires 36m35s835ms,
			     140.82.114.22 expires 34m10s969ms,
			     140.82.121.3 expires 29m18s940ms,
			     140.82.121.4 expires 30m27s53ms,
			     140.82.121.5 expires 29m20s120ms,
			     185.199.108.133 expires 29m19s352ms,
			     185.199.108.215 expires 29m19s335ms,
			     185.199.109.133 expires 29m19s353ms,
			     185.199.109.215 expires 29m19s333ms,
			     185.199.110.133 expires 29m19s353ms,
			     185.199.110.215 expires 29m19s334ms,
			     185.199.111.133 expires 29m19s354ms,
			     185.199.111.215 expires 29m19s334ms }
	}
}
```
...
peer: 2c1o9//w190B6DvPgsrJUr2+3wonW3NzNUojYxjMkkg=
  ...
  transfer: 0 B received, 26.47 KiB sent
